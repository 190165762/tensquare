...
public class RecruitController {
	...
	public Result newlist(){
		...
		return new Result(true, StatusCode.OK, "查询最新职位成功。", newlist);
	}

	@GetMapping("/search/recommend")
	public Result recommend(){
		List<Recruit> recommendlist = recruitService.recommend();
		return new Result(true, StatusCode.OK, "查询推荐职位成功。", recommendlist);
	}
